  ...
  return (
    <>
      ...
      {!showCardOnly && showSoftPrompt && permission === 'default' && (
        <div className="bg-gradient-to-r from-emerald-900 to-slate-900 text-white rounded-3xl p-5 shadow-xl border border-emerald-700/30 mb-5 relative overflow-hidden">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-bold text-base text-emerald-100">تفعيل الإشعارات الفورية (PWA)</h4>
              ...
              <div className="flex items-center gap-3 mt-4">
                <button
                  ...
                  disabled={loading}
                  className="bg-emerald-500 hover:bg-emerald-600 active:scale-95 text-slate-950 font-bold px-4 py-2 rounded-xl text-xs transition-all flex items-center gap-2 shadow-lg shadow-emerald-500/20"
                >
