...
export function AttendanceActionSkeleton() {
  return (
    <div className="w-full max-w-md mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between p-3 bg-white border border-slate-200/80 rounded-2xl">
        <Skeleton className="h-3 w-40" />
        <Skeleton className="h-6 w-16 rounded-full" />
      </div>

      {/* Main Biometric Card Skeleton */}
      <div className="p-6 bg-white border border-slate-200/80 rounded-3xl text-center space-y-6 flex flex-col items-center">
